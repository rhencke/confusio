...
function OnHttpRequest()
  ...
  elseif path == rb .. "/commits/abc123/status" then
    ...
    SetStatus(200, "OK")
    json(
      '{"state":"success","statuses":[{"id":1,"state":"success","context":"ci"}],'
        .. '"total_count":1,"sha":"abc123def456"}'
    )
  elseif path == rb .. "/commits/abc123/comments" then
    SetStatus(200, "OK")
    json(
      '[{"id":1,"body":"Nice commit","user":{"login":"octocat"},'
  ...
  elseif path == rb .. "/hooks/1" then
    SetStatus(200, "OK")
    json(
      '{"id":1,"type":"web","active":true,"events":["push"],'
  ...
  elseif path == rb .. "/issues/1/comments" then
    SetStatus(200, "OK")
    json(
      '[{"id":1,"body":"This is a comment","user":{"login":"octocat","id":1,"node_id":"","avatar_url":"","html_url":"","type":"User"},'
  ...
  elseif path == rb .. "/issues/1/events" then
    SetStatus(200, "OK")
    json(
      '[{"id":1,"event":"closed","actor":{"login":"octocat","id":1,"node_id":"","avatar_url":"","html_url":"","type":"User"},'
  ...
  elseif path == rb .. "/milestones/1" then
    SetStatus(200, "OK")
    json(
      '{"id":1,"number":1,"title":"v1.0","description":"First milestone","state":"open",'
        .. '"open_issues":1,"closed_issues":0,"created_at":"2020-01-01T00:00:00Z","updated_at":"2020-01-01T00:00:00Z",'
        .. '"due_on":null,"closed_at":null,"url":"","html_url":"","labels_url":"","node_id":""}'
    )
  ...
  elseif path == "/api/v3/user" then
    SetStatus(200, "OK")
    json(
      '{"login":"octocat","id":1,"node_id":"","avatar_url":"","html_url":"",'
  ...
  elseif path == "/api/v3/orgs/testorg/teams" then
    SetStatus(200, "OK")
    json(
      '[{"id":1,"name":"core","slug":"core","description":"Core team",'
  ...
  elseif path == "/api/v3/teams/1/repos" then
    SetStatus(200, "OK")
    json(
      '[{"id":1,"name":"hello-world","full_name":"testorg/hello-world","private":false,'
