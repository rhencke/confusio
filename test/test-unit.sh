...
for wh_backend in gitea forgejo codeberg gitlab bitbucket bitbucket_datacenter gitbucket launchpad phabricator pagure gerrit onedev radicle kallithea sourceforge tuleap codecommit confusio; do
...
# Phase 52: Startup event synthesis — github shape.
...
# Phase 53: Startup event synthesis — confusio shape.
# Same as Phase 52 but with webhook_target_shape=confusio; verifies
