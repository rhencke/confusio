...
function OnHttpRequest()
  ...
  local PROJECT =
    '{"id":"octocat%2Fhello-world","name":"octocat/hello-world",' ..
  ...
  elseif path == "/a/projects/" and method == "GET" then
    SetStatus(200, "OK")
    json('{"octocat/hello-world":{"id":"octocat%2Fhello-world",' ..
      '"description":"My first repo","state":"ACTIVE"}}')
  ...
  elseif path == rp .. "/commits/abc123" then
    SetStatus(200, "OK")
    json('{"commit":"abc123def456","message":"Initial commit",' ..
  ...
  elseif path:find("^/a/projects/octocat/hello%-world/branches/") and
         path:find("/files/") and
         path:find("/content$") then
    SetStatus(200, "OK")
