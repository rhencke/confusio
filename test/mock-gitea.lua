function OnHttpRequest()
  ...
  if auth ~= nil and auth ~= "token testtoken" then
    SetStatus(401, "Unauthorized"); return
  end
  ...
  local FOLLOWER =
    '[{"login":"hubot","id":2,"avatar_url":"","html_url":"","full_name":"Hubot",' ..
    '"email":"","is_admin":false,"location":"","website":"","followers_count":0,' ..
    '"following_count":0,"created":"2020-01-01T00:00:00Z"}]'

  local RELEASE =
    '{"id":1,"tag_name":"v1.0","name":"Release 1.0","body":"First release",' ..
  ...
  local routes = {
    ...
    ["/api/v1/repos/octocat/hello-world/contributors"]            = {200, '[{"login":"octocat","id":1,"contributions":100}]'},
    ["/api/v1/repos/octocat/hello-world/tags"]                    = {200, '[{"name":"v1.0","id":"abc123","message":"","commit":{"sha":"abc123def456","url":""}}]'},

    -- Branches
    ["/api/v1/repos/octocat/hello-world/branches"]                = {200,
    ...
    ["/api/v1/repos/octocat/hello-world/branches/main"]           = {200,
      '{"name":"main","commit":{"id":"abc123def456","message":"Initial commit",' ..
      '"url":"http://localhost/octocat/hello-world/commit/abc123def456"},"protected":false}'},

    -- Commits
    ["/api/v1/repos/octocat/hello-world/commits"]                 = {200,
    ...
    ["/api/v1/repos/octocat/hello-world/git/commits/abc123"]      = {200,
      '{"sha":"abc123def456","html_url":"http://localhost/octocat/hello-world/commit/abc123def456",' ..
      '"commit":{"message":"Initial commit","author":{"name":"Octocat","email":"octocat@github.com",' ..
      '"date":"2011-01-26T19:01:12Z"}}}'},
    ["/api/v1/repos/octocat/hello-world/statuses/abc123"]         = {200,
      '[{"id":1,"state":"success","description":"Build passed","context":"ci"}]'},
    ["/api/v1/repos/octocat/hello-world/commits/abc123/statuses"] = {200,
      '[{"id":1,"state":"success","description":"Build passed","context":"ci"}]'},

    -- Contents
    ["/api/v1/repos/octocat/hello-world/readme"]                  = {200,
      '{"name":"README.md","path":"README.md","sha":"abc123","size":100,' ..
      '"type":"file","encoding":"base64","content":"SGVsbG8gV29ybGQ="}'},

    -- Collaborators
    ["/api/v1/repos/octocat/hello-world/collaborators"]           = {200,
      '[{"login":"octocat","id":1,"avatar_url":"","type":"User"}]'},
    ["GET /api/v1/repos/octocat/hello-world/collaborators/octocat"] = {204, nil},
    ["/api/v1/repos/octocat/hello-world/collaborators/octocat/permission"] = {200,
      '{"permission":"admin","user":{"login":"octocat","id":1}}'},

    -- Forks
    ["/api/v1/repos/octocat/hello-world/forks"]                   = {200,
    ...
    ["/api/v1/repos/octocat/hello-world/releases/1/assets"]       = {200,
      '[{"id":1,"name":"binary.zip","size":1024,"download_count":5,' ..
      '"browser_download_url":"http://localhost/attachments/1"}]'},
    ["/api/v1/repos/octocat/hello-world/releases/assets/1"]       = {200,
      '{"id":1,"name":"binary.zip","size":1024,"download_count":5,' ..
      '"browser_download_url":"http://localhost/attachments/1"}'},

    -- Deploy keys
    ["/api/v1/repos/octocat/hello-world/keys"]                    = {200,
      '[{"id":1,"key":"ssh-rsa AAAAB3...","title":"my key","read_only":true,' ..
      '"created_at":"2020-01-01T00:00:00Z"}]'},
    ["/api/v1/repos/octocat/hello-world/keys/1"]                  = {200,
      '{"id":1,"key":"ssh-rsa AAAAB3...","title":"my key","read_only":true,' ..
      '"created_at":"2020-01-01T00:00:00Z"}'},

    -- Webhooks
    ["/api/v1/repos/octocat/hello-world/hooks"]                   = {200,
      '[{"id":1,"type":"gitea","active":true,"events":["push"],' ..
      '"config":{"url":"https://example.com/hook","content_type":"json"}}]'},
    ["/api/v1/repos/octocat/hello-world/hooks/1"]                 = {200,
      '{"id":1,"type":"gitea","active":true,"events":["push"],' ..
      '"config":{"url":"https://example.com/hook","content_type":"json"}}'},

    -- Compare
    ["/api/v1/repos/octocat/hello-world/compare/main...develop"]  = {200,
      '{"total_commits":3,"commits":[],"diff_stats":{"total":5,"additions":20,"deletions":5}}'},

    -- Repo comments
    ["/api/v1/repos/octocat/hello-world/comments"]                = {200,
      '[{"id":1,"body":"Nice commit","user":{"login":"octocat"},"created_at":"2020-01-01T00:00:00Z"}]'},
    ["/api/v1/repos/octocat/hello-world/comments/1"]              = {200,
      '{"id":1,"body":"Nice commit","user":{"login":"octocat"},"created_at":"2020-01-01T00:00:00Z"}'},
    ...
    ["/api/v1/user/keys"]                                         = {200,
      '[{"id":1,"key":"ssh-rsa AAAAB3N...","title":"my key","read_only":false,' ..
      '"created_at":"2020-01-01T00:00:00Z"}]'},
    ["/api/v1/user/keys/1"]                                       = {200,
      '{"id":1,"key":"ssh-rsa AAAAB3N...","title":"my key","read_only":false,' ..
      '"created_at":"2020-01-01T00:00:00Z"}'},
    ["/api/v1/users/octocat/keys"]                                = {200,
      '[{"id":1,"key":"ssh-rsa AAAAB3N...","title":"my key","read_only":false,' ..
      '"created_at":"2020-01-01T00:00:00Z"}]'},
