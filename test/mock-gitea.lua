function OnHttpRequest()
  ...
  local MILESTONE = '{"id":1,"title":"v1.0","description":"First milestone","state":"open",'
    .. '"open_issues":1,"closed_issues":0,'
    .. '"created_at":"2020-01-01T00:00:00Z","updated_at":"2020-01-01T00:00:00Z",'
    .. '"due_on":null,"closed_at":null}'

  local ISSUE = '{"id":1,"number":1,"title":"Found a bug","body":"Bug description",'
    .. '"state":"open","user":'
    .. USER
    .. ',"assignees":[],'
    .. '"labels":['
  ...
  local ISSUE_EVENT = '{"id":1,"comment_type":"CLOSE_ISSUE","user":'
    .. USER
    .. ',"content":"",'
  ...
  local routes = {
    ...
    ["PATCH /api/v1/repos/octocat/hello-world/issues/comments/1"] = { 200, ISSUE_COMMENT },
    ["DELETE /api/v1/repos/octocat/hello-world/issues/comments/1"] = { 204, nil },
    ...
    ["POST /api/v1/repos/octocat/hello-world/issues/1/comments"] = { 201, ISSUE_COMMENT },
