...
function OnHttpRequest()
  ...
  local REPO =
    '{"id":1,"path":"octocat/hello-world","description":"My first repo",' ..
  ...
  elseif path == rb .. "/commits/abc123" then
    SetStatus(200, "OK")
    json('{"sha":"abc123def456","message":"Initial commit",' ..
  ...
  elseif path == rb .. "/check/commits/abc123" then
    SetStatus(200, "OK")
    json('[{"id":1,"status":"success","check_suite_name":"ci",' ..
      '"started":"2020-01-01T00:00:00Z","ended":"2020-01-01T00:00:00Z"}]')

  -- Contents ---------------------------------------------------------------
  elseif path == rb .. "/content/README.md" then
    SetStatus(200, "OK")
    json('{"type":"file","name":"README.md","path":"README.md","sha":"abc123",' ..
  ...
  elseif path:find("^" .. rb:gsub("%-", "%%-") .. "/content/") then
    ...
    SetStatus(200, "OK")
    json('{"type":"file","name":"' .. file .. '","path":"' .. file .. '",' ..
  ...
  elseif path == rb .. "/keys/1" then
    SetStatus(200, "OK")
    json('{"id":1,"identifier":"my key","public_key":"ssh-rsa AAAAB3...",' ..
  ...
  elseif path == rb .. "/webhooks/1" then
    SetStatus(200, "OK")
    json('{"id":1,"identifier":"web","url":"https://example.com/hook",' ..
