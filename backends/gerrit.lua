...
backend_impl = {
  ...
  -- Checks — Gerrit has no native CI build system; all check endpoints are stubs.
  ...
  -- Check Suites — no Gerrit equivalent; all are stubs -----------------------
  ...
  -- Gerrit has no org/user migration export API matching GitHub's stateful
