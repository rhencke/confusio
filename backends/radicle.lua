...
backend_impl = {
  ...
  -- Checks — Radicle has no native CI build system; all check endpoints are stubs.
  ...
  -- Check Suites — no Radicle equivalent; all are stubs -------------------------
  ...
  -- Radicle has no org/user migration export API matching GitHub's stateful
