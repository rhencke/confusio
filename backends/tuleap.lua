...
backend_impl = {
  ...
  -- Checks — Tuleap has no native CI build system; all check endpoints are stubs.
  ...
  -- Check Suites — no Tuleap equivalent; all are stubs ----------------------------
  ...
  -- Tuleap has no org/user migration export API matching GitHub's stateful
