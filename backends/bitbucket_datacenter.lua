...
backend_impl = {
  ...
  -- Bitbucket Data Center has no org/user migration export API matching GitHub's
  -- stateful multi-repo model. All endpoints return fixed responses listed explicitly.
