...
backend_impl = {
  ...
  -- Checks — Kallithea has no native CI build system; all check endpoints are stubs.
  ...
  -- Check Suites — no Kallithea equivalent; all are stubs -----------------------
  ...
  -- Kallithea has no org/user migration export API matching GitHub's stateful
