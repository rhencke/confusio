...
gitea|issues-opened.json|issues-deleted.json|.action = "deleted" | .issue.state = "closed" | .issue.updated = "2024-01-15T10:05:00Z" | .sender.login = "octocat"
gitea|issues-opened.json|issues-labeled.json|.action = "label_updated" | .issue.body = null | .issue.labels = [{"id": 5, "name": "bug", "color": "#d73a4a", "url": ""}] | .issue.updated = "2024-01-15T10:01:00Z" | .label = {"id": 5, "name": "bug", "color": "#d73a4a", "url": ""}
gitea|issues-opened.json|issues-unlabeled.json|.action = "label_cleared" | .issue.body = null | .issue.updated = "2024-01-15T10:02:00Z" | .label = {"id": 5, "name": "bug", "color": "#d73a4a", "url": ""}
...
gitea|issues-opened.json|issues-milestoned.json|.action = "milestoned" | .issue.updated = "2024-01-15T10:06:00Z" | .issue.milestone = {"id": 1, "title": "v2.0", "description": "Version 2.0 release", "state": "open", "open_issues": 1, "closed_issues": 0, "created_at": "2024-01-01T00:00:00Z", "updated_at": "2024-01-15T10:06:00Z", "closed_at": null, "due_on": "2024-06-01T00:00:00Z", "html_url": "https://gitea.example.com/octo-org/octo-repo/milestone/1", "creator": {"id": 1, "login": "octocat", "avatar_url": "", "html_url": "https://gitea.example.com/octocat"}} | .milestone = .issue.milestone
gitea|issues-opened.json|issues-demilestoned.json|.action = "demilestoned" | .issue.updated = "2024-01-15T10:07:00Z" | .issue.milestone = null | .milestone = {"id": 1, "title": "v2.0", "description": "Version 2.0 release", "state": "open", "open_issues": 1, "closed_issues": 0, "created_at": "2024-01-01T00:00:00Z", "updated_at": "2024-01-15T10:07:00Z", "closed_at": null, "due_on": "2024-06-01T00:00:00Z", "html_url": "https://gitea.example.com/octo-org/octo-repo/milestone/1", "creator": {"id": 1, "login": "octocat", "avatar_url": "", "html_url": "https://gitea.example.com/octocat"}}
...
gitea|pull_request-opened.json|pull_request-deleted.json|.action = "deleted" | .pull_request.state = "closed" | .pull_request.updated = "2024-01-15T10:05:00Z" | .sender.login = "octocat"
gitea|pull_request-opened.json|pull_request-milestoned.json|.action = "milestoned" | .pull_request.updated = "2024-01-15T10:06:00Z" | .pull_request.milestone = {"id": 1, "title": "v2.0", "description": "Version 2.0 release", "state": "open", "open_issues": 1, "closed_issues": 0, "created_at": "2024-01-01T00:00:00Z", "updated_at": "2024-01-15T10:06:00Z", "closed_at": null, "due_on": "2024-06-01T00:00:00Z", "html_url": "https://gitea.example.com/octo-org/octo-repo/milestone/1", "creator": {"id": 1, "login": "octocat", "avatar_url": "", "html_url": "https://gitea.example.com/octocat"}} | .milestone = .pull_request.milestone
gitea|pull_request-opened.json|pull_request-demilestoned.json|.action = "demilestoned" | .pull_request.updated = "2024-01-15T10:07:00Z" | .pull_request.milestone = null | .milestone = {"id": 1, "title": "v2.0", "description": "Version 2.0 release", "state": "open", "open_issues": 1, "closed_issues": 0, "created_at": "2024-01-01T00:00:00Z", "updated_at": "2024-01-15T10:07:00Z", "closed_at": null, "due_on": "2024-06-01T00:00:00Z", "html_url": "https://gitea.example.com/octo-org/octo-repo/milestone/1", "creator": {"id": 1, "login": "octocat", "avatar_url": "", "html_url": "https://gitea.example.com/octocat"}}
gitea|pull_request-synchronize.json|pull_request-synchronized.json|.action = "synchronized"
gitea|pull_request_review-submitted.json|pull_request_approved-reviewed.json|.action = "reviewed" | .review.type = "pull_request_review_approved" | del(.review.state)
...
gitea|discussion-created.json|discussion-edited.json|.action = "edited" | .discussion.title = "How do I configure X? (edited)" | .discussion.body = "Updated question body." | .discussion.updated = "2024-01-15T10:01:00Z" | .changes = {"title": {"from": "How do I configure X?"}, "body": {"from": "I'm trying to configure X but can't figure it out."}}
gitea|discussion-created.json|discussion-deleted.json|.action = "deleted"
gitea|discussion-created.json|discussion-closed.json|.action = "closed" | .discussion.state = "closed" | .discussion.updated = "2024-01-15T10:02:00Z" | .sender.login = "octocat"
gitea|discussion-created.json|discussion-reopened.json|.action = "reopened" | .discussion.state = "open" | .discussion.updated = "2024-01-15T10:03:00Z" | .sender.login = "octocat"
gitea|discussion-created.json|discussion-labeled.json|.action = "labeled" | .discussion.labels = [{"id": 5, "name": "question", "color": "#d876e3", "url": ""}] | .discussion.updated = "2024-01-15T10:01:00Z" | .label = {"id": 5, "name": "question", "color": "#d876e3", "url": ""}
gitea|discussion-created.json|discussion-unlabeled.json|.action = "unlabeled" | .discussion.updated = "2024-01-15T10:02:00Z" | .label = {"id": 5, "name": "question", "color": "#d876e3", "url": ""}
gitea|discussion_comment-created.json|discussion_comment-deleted.json|.action = "deleted"
gitea|discussion_comment-created.json|discussion_comment-edited.json|.action = "edited" | .comment.body = "Try setting the X option in the config. (edited)" | .comment.updated = "2024-01-15T10:10:00Z" | .changes = {"body": {"from": "Try setting the X option in the config."}}
gitea|package-published.json|package-deleted.json|.action = "deleted"
...
gitbucket|project-created.json|project-closed.json|.action = "closed" | .project.state = "closed" | .project.updated_at = "2024-01-15T11:00:00Z"
gitbucket|project-created.json|project-reopened.json|.action = "reopened" | .project.state = "open" | .project.updated_at = "2024-01-15T12:00:00Z"
gitbucket|project-created.json|project-edited.json|.action = "edited" | .project.name = "My Project (updated)" | .project.body = "Updated description" | .project.updated_at = "2024-01-15T10:30:00Z"
gitbucket|project-created.json|project-deleted.json|.action = "deleted"
gitbucket|project_card-created.json|project_card-moved.json|.action = "moved" | .project_card.column_id = 2 | .project_card.column_url = "http://localhost/projects/columns/2" | .project_card.updated_at = "2024-01-15T10:10:00Z"
gitbucket|project_card-created.json|project_card-converted.json|.action = "converted" | .project_card.content_url = "http://localhost/repos/octocat/hello-world/issues/1" | .project_card.note = null | .project_card.updated_at = "2024-01-15T10:05:00Z"
gitbucket|project_card-created.json|project_card-edited.json|.action = "edited" | .project_card.note = "Updated card note" | .project_card.updated_at = "2024-01-15T10:20:00Z"
gitbucket|project_card-created.json|project_card-deleted.json|.action = "deleted"
gitbucket|project_column-created.json|project_column-edited.json|.action = "edited" | .project_column.name = "In Progress" | .project_column.updated_at = "2024-01-15T10:30:00Z"
gitbucket|project_column-created.json|project_column-moved.json|.action = "moved" | .project_column.after_id = 2 | .project_column.updated_at = "2024-01-15T10:20:00Z"
gitbucket|project_column-created.json|project_column-deleted.json|.action = "deleted"
gitbucket|projects_v2-created.json|projects_v2-closed.json|.action = "closed" | .projects_v2.status = "closed" | .projects_v2.closed_at = "2024-01-15T11:00:00Z" | .projects_v2.updated_at = "2024-01-15T11:00:00Z"
gitbucket|projects_v2-created.json|projects_v2-reopened.json|.action = "reopened" | .projects_v2.status = "open" | .projects_v2.closed_at = null | .projects_v2.updated_at = "2024-01-15T12:00:00Z"
gitbucket|projects_v2-created.json|projects_v2-edited.json|.action = "edited" | .projects_v2.title = "My V2 Project (updated)" | .projects_v2.updated_at = "2024-01-15T10:30:00Z"
gitbucket|projects_v2-created.json|projects_v2-deleted.json|.action = "deleted"
gitbucket|projects_v2_item-created.json|projects_v2_item-archived.json|.action = "archived" | .projects_v2_item.archived_at = "2024-01-15T10:10:00Z" | .projects_v2_item.updated_at = "2024-01-15T10:10:00Z"
gitbucket|projects_v2_item-created.json|projects_v2_item-converted.json|.action = "converted" | .projects_v2_item.content_type = "Issue" | .projects_v2_item.updated_at = "2024-01-15T10:05:00Z"
gitbucket|projects_v2_item-created.json|projects_v2_item-edited.json|.action = "edited" | .projects_v2_item.updated_at = "2024-01-15T10:20:00Z"
gitbucket|projects_v2_item-created.json|projects_v2_item-reordered.json|.action = "reordered" | .projects_v2_item.updated_at = "2024-01-15T10:15:00Z"
gitbucket|projects_v2_item-created.json|projects_v2_item-restored.json|.action = "restored" | .projects_v2_item.archived_at = null | .projects_v2_item.updated_at = "2024-01-15T10:25:00Z"
gitbucket|projects_v2_item-created.json|projects_v2_item-deleted.json|.action = "deleted"
gitbucket|projects_v2_status_update-created.json|projects_v2_status_update-edited.json|.action = "edited" | .projects_v2_status_update.status = "AT_RISK" | .projects_v2_status_update.body = "Some items are at risk." | .projects_v2_status_update.updated_at = "2024-01-15T10:30:00Z"
gitbucket|projects_v2_status_update-created.json|projects_v2_status_update-deleted.json|.action = "deleted"
gitbucket|discussion-created.json|discussion-edited.json|.action = "edited" | .discussion.title = "How do I configure X? (edited)" | .discussion.body = "I'm trying to configure X but can't figure it out. (edited)" | .discussion.updated_at = "2024-01-15T10:30:00Z"
gitbucket|discussion-created.json|discussion-deleted.json|.action = "deleted"
gitbucket|discussion-created.json|discussion-closed.json|.action = "closed" | .discussion.state = "closed" | .discussion.state_reason = "resolved" | .discussion.updated_at = "2024-01-15T11:00:00Z"
gitbucket|discussion-created.json|discussion-reopened.json|.action = "reopened" | .discussion.state = "open" | .discussion.state_reason = null | .discussion.updated_at = "2024-01-15T12:00:00Z"
gitbucket|discussion-created.json|discussion-answered.json|.action = "answered" | .discussion.answer_html_url = "http://localhost/octocat/hello-world/discussions/1#discussioncomment-99" | .discussion.answer_chosen_at = "2024-01-15T11:00:00Z" | .discussion.answer_chosen_by = {"id": 1, "login": "alice", "avatar_url": "", "html_url": ""} | .discussion.updated_at = "2024-01-15T11:00:00Z"
gitbucket|discussion-created.json|discussion-labeled.json|.action = "labeled" | .discussion.labels = [{"id": 1, "node_id": "LA_kwDOBQ8MAA", "name": "question", "color": "e4e669", "default": false, "description": ""}] | .label = {"id": 1, "node_id": "LA_kwDOBQ8MAA", "name": "question", "color": "e4e669", "default": false, "description": ""}
